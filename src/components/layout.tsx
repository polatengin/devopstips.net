...
import { DayIcon, ExternalLinkIcon, NightIcon, RSSIcon, TwitterIcon } from "./icons";
      ...
      <div className="dark:bg-gray-800">
        ...
        <main className="max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row">
          <aside className="w-screen md:w-56 flex-none text-gray-800 dark:text-white px-3 md:px-6 py-6 border-t md:border-t-0 md:border-r">
            <h2 className="text-lg">Tips and Tricks about Azure DevOps and GitHub</h2>
        ...
        <footer className="h-10 flex items-center border-t text-gray-800 dark:text-gray-100">
          ...
          <button className="w-8 h-8 mr-6 inline md:hidden items-center bg-gray-100 dark:bg-gray-900 outline-none focus:outline-none rounded-full shadow-inner" onClick={() => {
            localStorage.setItem("theme", theme !== "dark" ? "dark" : "light" );
            setTheme(localStorage.getItem("theme"));
          }}>
